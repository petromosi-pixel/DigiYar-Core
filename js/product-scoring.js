 ...
 *
 * محصولی که از سقف بودجه عبور کند
 * نباید صرفاً با کم‌کردن امتیاز وارد
 * فرآیند رتبه‌بندی شود.
 *
 * محصولات خارج از بودجه در recommend()
 * نیز فیلتر می‌شوند.
 *
 * این بررسی دوم، یک لایه دفاعی است.
 * -------------------------------------------------------
 */
