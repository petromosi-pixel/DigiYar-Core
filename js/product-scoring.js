 ...
 *
 * محصولات خارج از بودجه قبلاً در recommend()
 * حذف می‌شوند؛ بنابراین اینجا قیمت نباید
 * به خاطر ارزان‌تر بودن باعث کاهش امتیاز شود.
 *
 * -------------------------------------------------------
 */
 ...
 * محصول داخل بودجه:
 *
 * هیچ امتیاز مصنوعی بر اساس میزان خرج‌کردن
 * اضافه نمی‌کنیم.
 *
 * محصول ارزان‌تر به خاطر ارزان بودن تنبیه نمی‌شود.
 */
