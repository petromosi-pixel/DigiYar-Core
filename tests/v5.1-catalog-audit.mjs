...
const nav=/^(قیمت \(تومان\)|گارانتی|فروشگاه|استان|تاریخ|برندهای موبایل|موبایل یاب|برندها)$/i;
const badUrl=/\/search(?:\/|\?|$)|\/phones\/(?:index|brands|finder|reviews|addtocompare|prices)(?:\.aspx)?(?:\?|$)/i;
